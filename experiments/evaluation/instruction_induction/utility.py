...
def get_f1_score(prediction, ground_truth):
    ...
    # print("Prediction and Answer = ",(prediction_tokens+"answer : ",ground_truth_tokens))
...
def get_em_score(prediction, ground_truth):
    ...
    print("Prediction and Answer = ",(prediction_normalized+"answer : ",ground_truth_normalized))
...
def get_multi_answer_f1(prediction, answers):
    f1_scores = []
    for answer in answers:
        print("Prediction and Answer = ",(prediction+"........\.........",answer))
